...
import 'package:psychological_consultation/src/component/videoPlayerDetail.dart';
...
class ResourcesDetailPage extends StatefulWidget {
  ...
  const ResourcesDetailPage(this.data, {Key? key}) : super(key: key);
        ...
        children: [
          ...
          TextButton(
              onPressed: isdownloading
                  ? null
                  : () async {
                await SessionManager().set(widget.data['resource_url'], 0);
                      FileDownloader.downloadFile(
                          ...
                          onProgress: (filname,value) async {
                            print("download file ${filname!} $value");
                           await SessionManager().set(widget.data['resource_url'], value);
                      },
                ...
                child: Column(
                  ...
                  children: [
                    const Text(
                      ...
                      style: TextStyle(
                          fontSize: 16, color: appColors.textP),
